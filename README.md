...
+ **Title: 오늘어때**
+ **Introduction:** 
  + **"오늘어때"** 는 날씨 데이터를 기반으로 한 혁신적인 숙박 예약 플랫폼입니다. 
    + 이 프로젝트는 숙박업소의 공실률을 최소화하고, 소비자들에게 합리적인 비용으로 숙박과 여행을 즐길 기회를 제공하기 위해 기획되었습니다.
## 프로그램 주요 기능
...
+ **양도:**
  + 숙박 예약 내역이 회원 정보에 존재하고 사용 가능한 예약인 경우 양도게시판에 게시글을 작성 할 수 있습니다.
  + 회원간의 편의 기능으로 결제시 바로 회원 예약 정보가 이동되어 양수자는 숙박권을 바로 사용할 수 있습니다.
